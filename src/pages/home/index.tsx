    ...
    <Content style={{ padding: '50px 0', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: 'calc(100vh - 64px)' }}>
      <div style={{ textAlign: 'center', maxWidth: 800, padding: '0 20px' }}>
        <Title level={1} style={{ fontSize: '3rem', marginBottom: '1rem' }}>
          Hello, I'm <span style={{ color: '#1890ff' }}>Developer</span>
        </Title>
        ...
        <Paragraph style={{ fontSize: '1.2rem', color: '#555', marginBottom: '3rem' }}>
          ...
          Passionate about clean code, modern technologies, and creating value through software.
        </Paragraph>
        ...
        <Space size="large">
          ...
          <Button size="large" icon={<GithubOutlined />} href="https://github.com" target="_blank">
            GitHub
          </Button>
          <Button size="large" icon={<MailOutlined />} href="mailto:example@email.com">
            Contact Me
          </Button>
        </Space>
      </div>
